{{-- ═══════════════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════════════ --}}
<div x-show="currentView === 'subjects'" class="flex gap-8 min-h-0" x-transition>
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="pt-5 border-t border-slate-100 space-y-3">
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest">Subject Record</span>
                                    </div>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-1">
                    ...
                    <select x-model="subjectFilterBoard" @change="subjectPage = 1"
                            class="w-full rounded-xl border border-slate-200 bg-white py-2 px-3 text-slate-800 focus:ring-2 focus:ring-purple-500 text-xs outline-none">
